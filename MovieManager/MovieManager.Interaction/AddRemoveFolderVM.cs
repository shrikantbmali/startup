...
namespace MovieManager.Interaction
{
	internal class AddRemoveFolderVM : BindableBase, IAddRemoveFolderVM, IFirstTimeViewModel
	{
		...
		private IMediaCollection _collectionManager;
		...
		{
			var showMessageBox = _messengerService.ShowMessageBox("Warning!",
				"Are you sure to remove this movie lcation?" + Environment.NewLine +
				"We will not be able to show any movie from this location.", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
